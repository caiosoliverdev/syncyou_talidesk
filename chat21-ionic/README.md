...
Chat21 is the core of the open source live chat platform [SyncYou.com](http://www.tiledesk.com). SyncYou is an Open Source Live Chat platform with integrated Chatbots written in NodeJs and Express. Build your own customer support with a multi-channel platform for Web, Android and iOS.
