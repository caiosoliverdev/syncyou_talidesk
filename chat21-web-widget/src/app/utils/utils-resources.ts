export const BRAND_BASE_INFO: { [key: string] : string} ={
    ...
    POWERED_BY:"<a tabindex='-1' target='_blank' ref='https://www.tiledesk.com/?utm_source=widget'><img src='https://support-pre.tiledesk.com/dashboard/assets/img/logos/tiledesk-solo_logo_new_gray.svg'/><span>Powered by SyncYou</span></a>",
}
