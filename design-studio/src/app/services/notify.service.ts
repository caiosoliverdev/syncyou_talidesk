...
export class NotifyService {
  ...
  contacUsViaEmail() {
    window.open('mailto:sales@tiledesk.com?subject=Upgrade SyncYou plan');
    this.closeContactUsModalToUpgradePlan()
  }
  
  contacUsViaEmailPlanC() {
    window.open(`mailto:sales@tiledesk.com?subject=Upgrade SyncYou plan (${PLAN_NAME.C} expired)`);
