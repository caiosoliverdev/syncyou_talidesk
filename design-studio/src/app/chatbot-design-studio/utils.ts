...
//             { name: 'user_country', value: 'user_country', description: 'The user Country as decoded by SyncYou',src: '', icon: 'language' },
//             { name: 'user_city', value: 'user_city', description: 'The user City as decoded by SyncYou', src: '', icon: 'language' },
...
//             { name: 'user_id', value: 'user_id', description: 'The user unique ID inside SyncYou database', src: '', icon: 'person' },
